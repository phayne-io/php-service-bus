...
abstract class MessageBus
{
    ...
    public function __construct(
        protected readonly ?ActionEventEmitter $events = new PhayneActionEventEmitter([self::EVENT_DISPATCH, self::EVENT_FINALIZE]) //phpcs:ignore
    ) {
            ...
            function (ActionEvent $actionEvent): void {
                if ($actionEvent->param(self::EVENT_PARAM_MESSAGE_NAME) === null) {
                    $actionEvent->setParam(
                        ...
                        $this->getMessageName($actionEvent->param(self::EVENT_PARAM_MESSAGE))
                    );
                }
            },
    ...
    abstract public function dispatch(mixed $message);
